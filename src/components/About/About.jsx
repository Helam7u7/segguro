    ...
    <div className="about">
      ...
      <section className='section-lego about-section'>
        ...
        <div className='grid-lego'>
          <div className='lego-item'><img src="public/lego/yellow.png" alt="" /></div>
          <div className='lego-item'><img src="public/lego/red.png" alt="" /></div>
          <div className='lego-item'><img src="public/lego/green.png" alt="" /></div>
          <div className='lego-item'><img src="public/lego/blue.png" alt="" /></div>
        </div>
      </section>
